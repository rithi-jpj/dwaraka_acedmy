...
const FACULTY = [
  { name: 'Dr. Rajesh Kumar', subject: 'Physics', qualification: 'Ph.D, IIT Delhi', experience: '15+ Years' },
  { name: 'Mrs. Sunita Sharma', subject: 'Chemistry', qualification: 'M.Sc, B.Ed', experience: '12+ Years' },
  { name: 'Mr. Anil Verma', subject: 'Mathematics', qualification: 'M.Sc, NET Qualified', experience: '10+ Years' },
  { name: 'Dr. Priya Singh', subject: 'Biology', qualification: 'Ph.D, AIIMS', experience: '8+ Years' },
  { name: 'Mr. Vikram Patel', subject: 'English', qualification: 'M.A, B.Ed', experience: '14+ Years' },
  { name: 'Ms. Neha Gupta', subject: 'Chemistry', qualification: 'M.Sc, Ph.D', experience: '9+ Years' },
];

const TESTIMONIALS_DATA = [
  { name: 'Mr. Suresh Patel', role: 'Parent of Class 10 Student', text: 'Dwaraka Academy has been instrumental in my child\'s academic growth. The teachers are dedicated and the personalised attention is remarkable.', rating: 5 },
  { name: 'Rahul Sharma', role: 'JEE Advanced 2024 Topper', text: 'The rigorous training and concept-based teaching at Dwaraka Academy helped me clear JEE Advanced with flying colours. Grateful for the amazing faculty!', rating: 5 },
  { name: 'Mrs. Anjali Mehta', role: 'Parent of Class 12 Student', text: 'My daughter improved significantly after joining Dwaraka Academy. The weekly tests and performance analysis kept us updated on her progress.', rating: 5 },
  { name: 'Kavya Reddy', role: 'NEET 2024 Qualifier', text: 'The structured curriculum and mock tests at Dwaraka Academy prepared me thoroughly for NEET. The faculty\'s guidance was invaluable.', rating: 5 },
  { name: 'Mr. Amit Joshi', role: 'Parent of Class 8 Student', text: 'Excellent academy with modern teaching methods. My son enjoys learning here and his grades have improved tremendously.', rating: 5 },
  { name: 'Arjun Singh', role: 'CBSE Class 12 Topper', text: 'Dwaraka Academy provided me with the perfect environment to excel. The teachers are supportive and the study material is top-notch.', rating: 5 },
];

const GALLERY_IMAGES = [
  { src: '/images/academy/hero-academy.svg', alt: 'Dwaraka Academy Building', label: 'Academy Building' },
  { src: '/images/academy/about-academy.svg', alt: 'Dwaraka Academy Academics', label: 'Academic Excellence' },
  { src: '/images/academy/gallery-1.svg', alt: 'Dwaraka Academy Campus', label: 'Campus Life' },
  { src: '/images/academy/gallery-2.svg', alt: 'Dwaraka Academy Learning', label: 'Learning Environment' },
];
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-3 mt-6"
        >
          {['Quality Education', 'Experienced Faculty', 'Excellent Results', 'Individual Attention'].map((h) => (
        ...
        >
          {[
            { end: 2000, suffix: '+', label: 'Students Taught', icon: <Users className="w-5 h-5" /> },
            { end: 25, suffix: '+', label: 'Expert Faculty', icon: <GraduationCap className="w-5 h-5" /> },
            { end: 14, suffix: '+', label: 'Years of Excellence', icon: <Award className="w-5 h-5" /> },
            { end: 98, suffix: '%', label: 'Success Rate', icon: <Target className="w-5 h-5" /> },
          ].map((stat, i) => (
...
function AboutSection() {
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle title="About Dwaraka Academy" subtitle="Our Story" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <p className="text-lg text-slate-600 leading-relaxed">
              <span className="font-bold text-purple-700">Dwaraka Academy</span> is a premier educational institution 
              dedicated to shaping the future of students through comprehensive coaching for CBSE, JEE, and NEET examinations.
            </p>
            <p className="text-slate-600 leading-relaxed">
              Since our establishment in 2020, we have been committed to providing quality education 
              that goes beyond textbooks. Our experienced faculty, innovative teaching methods, and 
              student-centric approach ensure every learner achieves their full potential.
            </p>
...
function FacultyCard({ faculty, index }: { faculty: typeof FACULTY[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="inline-block px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-xs font-semibold mt-2 mb-3">
        {faculty.subject}
      </span>
          ...
          <div className="relative overflow-hidden min-h-[280px]" onMouseEnter={pauseAutoPlay} onMouseLeave={resumeAutoPlay}>
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div>
                  <div className="font-bold text-slate-900">{TESTIMONIALS_DATA[current].name}</div>
                  <div className="text-sm text-slate-500">{TESTIMONIALS_DATA[current].role}</div>
                </div>
              </motion.div>
            </AnimatePresence>
          </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-5">
                <div className="text-white">
                  ...
                  <p className="text-xs text-white/70 mt-0.5">Tap to view</p>
                </div>
              </div>
            </motion.div>
          ))}
...
function EnquirySection() {
  const [form, setForm] = useState({ studentName: '', parentName: '', phone: '', email: '', course: '', message: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.studentName || !form.parentName || !form.phone || !form.email) {
    ...
    setLoading(true);
    // Log enquiry data (would send to backend in production)
        ...
        >
          {submitted ? (
            ...
            >
              ...
              <button
                onClick={() => { setSubmitted(false); setForm({ studentName: '', parentName: '', phone: '', email: '', course: '', message: '' }); }}
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="space-y-6">
              {[
                { icon: <MapPin className="w-5 h-5" />, title: 'Address', content: '123, Academic Block, Education City,\nMain Road, District - 123456' },
                { icon: <Phone className="w-5 h-5" />, title: 'Phone', content: '+91 98765 43210\n+91 98765 43211' },
                { icon: <Mail className="w-5 h-5" />, title: 'Email', content: 'info@dwarakaacademy.com\nadmissions@dwarakaacademy.com' },
                { icon: <Clock className="w-5 h-5" />, title: 'Working Hours', content: 'Mon – Sat: 7:00 AM – 7:00 PM\nSunday: 9:00 AM – 1:00 PM' },
              ].map((item, i) => (
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="rounded-3xl overflow-hidden shadow-xl border border-slate-100 h-[400px] lg:h-auto"
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.5!2d77.5!3d13.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDAwJzAwLjAiTiA3N8KwMzAnMDAuMCJF!5e0!3m2!1sen!2sin!4v1"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-xl font-extrabold">
                Dwaraka <span className="text-amber-400">Academy</span>
              </span>
            </Link>
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Empowering students with quality education since 2020. Your journey to academic excellence starts here.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-slate-400">
                ...
                <span>123, Academic Block, Education City</span>
              </li>
              ...
              <li className="flex items-center gap-3 text-sm text-slate-400">
                ...
                <span>info@dwarakaacademy.com</span>
              </li>
            </ul>
          </div>
        </div>
