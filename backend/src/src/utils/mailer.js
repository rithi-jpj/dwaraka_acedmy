...
function passwordChangedEmail({ name, email }) {
  const bodyHtml =
    '<h2>Password Changed &#10003;</h2>' +
    '<p>Hello <strong>' + name + '</strong>,</p>' +
    '<p>Your Dwaraka Academy password was changed successfully.</p>' +
    '<p>If you did not make this change, please contact the academy administration immediately.</p>' +
    '<p style="text-align:center;margin-top:20px;">' +
      '<a class="btn" href="' + (env.CORS_ORIGIN || 'http://localhost:3000') + '/login">Go to Portal</a>' +
    '</p>';
  return {
    subject: 'Password Changed Successfully \u2014 Dwaraka Academy',
...
module.exports = {
  ...
  getEtherealPreviewUrl: () => etherealPreviewUrl,
};
